...
public:
	...
	static FHeartFlake CreateFlake_Struct(const FInstancedStruct& Struct, FName Serializer);
	...
	static FHeartFlake CreateFlake(const UObject* Object, FName Serializer);
	...
	static FHeartFlake_Actor CreateFlake_Actor(const AActor* Actor, FName Serializer);
	...
	static FInstancedStruct ConstructStructFromFlake(const FHeartFlake& Flake, const UScriptStruct* ExpectedStruct, FName Serializer);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Heart|FlakeLibrary", meta = (DeterminesOutputType = "ExpectedClass"))
	static UObject* ConstructObjectFromFlake(const FHeartFlake& Flake, UObject* Outer, const UClass* ExpectedClass, FName Serializer);
	...
	static AActor* ConstructActorFromFlake(const FHeartFlake_Actor& Flake, UObject* WorldContextObj, const TSubclassOf<AActor> ExpectedClass, FName Serializer);
};